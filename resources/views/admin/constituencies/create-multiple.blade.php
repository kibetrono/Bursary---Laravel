    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h3>Add Multiple Constituencies</h3>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">Add Multiple Constituencies
                            </li>
                        </ol>
                    </div>
                </div>
                    ...
                    <div class="col">
                        <div class="card card-info">
                            <div class="card-header">
                                <h3 class="card-title">Add New Constituency</h3>
                            </div>
                            <div class="card-body">
                                <form action="{{ route('constituency.store') }}" method="POST">
                                    ...
                                    <div class="form-group">
                                        <div class="d-flex align-items-center justify-content-between">
                                            <label for="">Constituency Names</label>
                                            <div class="form-group">
                                                <button type="button" id="add-field" class="btn-sm btn btn-primary"><i
                                        ...
                                        <div id="constituency-container">
                                            <div class="input-group mb-3">
                                                <input type="text"
                                                    ...
                                                    required placeholder="Constituency name">
                                                @error('name')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                    ...
                                    <div class="form-group">
                                        <button style="border: unset" type="submit" class="btn btn-success"><i
                                                class="fas fa-save"></i> Save Constituencies</button>
                                    </div>
                                </form>
                            </div>
                        </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#add-field').click(function() {
                var field = `
                    <div class="input-group mb-3">
                        <input type="text" class="form-control @error('name.*') is-invalid @enderror" name="name[]" required placeholder="Constituency name">
                ...
                `;
                $('#constituency-container').append(field);
            });
