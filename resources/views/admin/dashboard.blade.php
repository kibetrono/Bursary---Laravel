                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-12">
                        ...
                        <div class="small-box bg-warning">
                            ...
                            <a href="{{url('admin/bursary')}}" class="small-box-footer">More info <i
                                    class="fas fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                                ...
                                <div class="direct-chat-contacts">
                                    <ul class="contacts-list">
                                        <li>
                                            <a href="#">
                                                <img class="contacts-list-img"
                                                    src="{{ url('Admin/dist/img/user1-128x128.jpg') }}"
                                                    alt="User Avatar">
                                        ...
                                        <li>
                                            <a href="#">
                                                <img class="contacts-list-img"
                                                    src="{{ url('Admin/dist/img/user7-128x128.jpg') }}"
                                                    alt="User Avatar">
                                        ...
                                        <li>
                                            <a href="#">
                                                <img class="contacts-list-img"
                                                    src="{{ url('Admin/dist/img/user3-128x128.jpg') }}"
                                                    alt="User Avatar">
                                        ...
                                        <li>
                                            <a href="#">
                                                <img class="contacts-list-img"
                                                    src="{{ url('Admin/dist/img/user5-128x128.jpg') }}"
                                                    alt="User Avatar">
                                        ...
                                        <li>
                                            <a href="#">
                                                <img class="contacts-list-img"
                                                    src="{{ url('Admin/dist/img/user6-128x128.jpg') }}"
                                                    alt="User Avatar">
                                        ...
                                        <li>
                                            <a href="#">
                                                <img class="contacts-list-img"
                                                    src="{{ url('Admin/dist/img/user8-128x128.jpg') }}"
                                                    alt="User Avatar">
                            ...
                            <div class="card-footer bg-transparent">
                                <div class="row">
                                    ...
                                    <div class="col-4 text-center">
                                        ...
                                        <div class="text-white">Bursaries</div>
                                    </div>
                                    <!-- ./col -->
                                </div>
                                <!-- /.row -->
