                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">Add Multiple Locations
                            </li>
                        </ol>
                    </div>
                </div>
                                ...
                                <form action="{{ route('location.store') }}" method="POST">
                                    ...
                                    <div class="form-group">
                                        <div class="d-flex align-items-center justify-content-between">
                                            <label for="">Location Names</label>
                                            <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <button style="border: unset" type="submit" class="btn btn-success"><i
                                                class="fas fa-save"></i> Save Locations</button>
                                    </div>
                                </form>
                            </div>
                        </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#add-field').click(function() {
                var field = `
                    <div class="input-group mb-3">
                        <input type="text" class="form-control @error('name.*') is-invalid @enderror" name="name[]" required placeholder="Location name">
                ...
                `;
                $('#location-container').append(field);
            });
