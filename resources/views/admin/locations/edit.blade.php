                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-info">
                            <div class="card-header">
                                <h3 class="card-title">Update Location: {{ $location->name }}</h3>
                                <div class="card-tools">
                                </div>
                            </div>
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form action="{{ route('location.update', $location->id) }}" method="POST" class="my-4">
                                @csrf
                                @method('PUT')
                                <div class="row">
                                    ...
                                    <div class="input-group mb-3 px-4">
                                        <input id="name" type="text"
                                            ...
                                            value="{{ $location->name }}" required autocomplete="name" autofocus
