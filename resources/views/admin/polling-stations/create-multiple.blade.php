    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h3>Add Multiple Polling Station</h3>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">Add Multiple Polling Stations
                            </li>
                        </ol>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col">
                        <div class="card card-info">
                            ...
                            <div class="card-body">
                                <form action="{{ route('polling-station.store') }}" method="POST">
                                    @csrf
                                    ...
                                    <div class="form-group">
                                        <div class="d-flex align-items-center justify-content-between">
                                            <label for="">Polling Station Names</label>
                                            <div class="form-group">
                                                <button type="button" id="add-field" class="btn-sm btn btn-primary"><i class="fas fa-plus-circle"></i></button>
                                            </div>
                                        </div>
                                        <div id="polling-station-container">
                                            <div class="input-group mb-3">
                                                <input type="text" class="form-control @error('name') is-invalid @enderror" name="name[]" required placeholder="Polling station name">
                                                @error('name')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                    ...
                                    <div class="form-group">
                                        <button style="border: unset" type="submit" class="btn btn-success"><i class="fas fa-save"></i> Save Polling Stations</button>
                                    </div>
                                </form>
                            </div>
                        </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#add-field').click(function() {
                ...
                `;
                $('#polling-station-container').append(field);
            });
