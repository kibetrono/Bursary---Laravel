                                ...
                                <div class="row">
                                    <div class="col-xl-2 flex-container">
                                        <div style="border-top-left-radius:10px;border-top-right-radius:10px"
                                            ...
                                            <div style="border-top-left-radius:10px;border-top-right-radius:10px"
                                                class="list-group list-group-flush " id="custom-setting-sidenav">
                                    ...
                                    <div class="col-xl-10 col-xl-10-content">
                                                    ...
                                                    @can('edit system setting')
                                                        <div class="row mt-2">
                                                            <div class="form-group col-md-6">
                                                                <a href="#" style='border-radius:7px'
                                                            ...
                                                            <div class="form-group col-md-6 text-end">
                                                                <input style='border-radius:7px' class="btn btn-info"
                                        ...
                                        <div id="custom-setting-3" class="card">
                                            <div class="card-header">
                                                <h5>{{ __('Email Action Notification') }}</h5>
                                            </div>
                                            ...
                                            <div class="card-body">
                                                <form method="POST" id="email_notification_row"
                                                    ...
                                                    @can('edit system setting')
                                                        <div class="row mt-2">
                                                            <div class="form-group col-md-6 text-end">
                                                                <input class="btn btn-info" style='border-radius:7px'
                                                                    type="submit" value="Save Changes">
                                                            </div>
                                                        </div>
                                                    @endcan
                            ...
                            <div class="modal-content">
                                ...
                                @can('edit system setting')
                                    <div class="modal-footer">
                                        <button type="button" style='border-radius:7px' class="btn btn-secondary"
                                            data-dismiss="modal">Close</button>
                                        <button type="button" style='border-radius:7px' class="btn btn-info"
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            navLinks.forEach(function(navLink) {
                navLink.addEventListener('click', function(e) {
                    ...
                    'href'); // Get the href attribute of the clicked link
                    const targetSection = document.querySelector(target); // Get the target section
        ...
        document.addEventListener('DOMContentLoaded', function() {
            document.getElementById('sendTestEmailBtn').addEventListener('click', function() {
                ...
                if (subject.trim() === '' || body.trim() === '') {
                    ...
                    $.ajax({
                        url: '{{ route('send-configuration-test-email') }}',
                        type: 'POST',
                        data: {
                            subject: subject,
                            body: body
