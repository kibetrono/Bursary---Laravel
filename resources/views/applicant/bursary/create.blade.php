                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-info">
                            ...
                            @if ($applicationActive)
                                    ...
                                    <div class="card-body pt-0">
                                        <form id="application_form" action="{{ route('user.bursary.store') }}"
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group first_name required">
                                                            ...
                                                            <input type="text" id="first_name"
                                                                ...
                                                                name="first_name" aria-required="true"
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group last_name required">
                                                            ...
                                                            <input type="text" id="last_name"
                                                                ...
                                                                name="last_name" aria-required="true"
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group id_or_passport_no required">
                                                            <label class="control-label"
                                                                for="id_or_passport_no">ID/Passport
                                                                no.:</label>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group parental_status required">
                                                            ...
                                                            <select id="parental_status" name="parental_status"
                                                                ...
                                                                required>
                                                                <option value="" selected disabled>Select parental
                                                                    status
                                                                </option>
                                                                <option value="Single Parent">Single Parent</option>
                                                                <option value="One Parent Dead">One Parent Dead</option>
                                                                <option value="Both Parents Dead">Both Parents Dead
                                                                </option>
                                                                <option value="Both Parents Alive">Both Parents Alive
                                                                </option>
                                                                <option value="Others">Others</option>
                                                            </select>
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group number_of_siblings required">
                                                            <label class="control-label" for="number_of_siblings">Number
                                                                of Siblings: <span class="text-danger">*</span></label>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group constituency required">
                                                            <label class="control-label" for="constituency">Constituency:
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group location required">
                                                            ...
                                                            <select id="location" class="form-control"
                                                                name="location_id" aria-required="true" required disabled>
                                                                <option value="" selected disabled> --- Select
                                                                    location ---
                                                                </option>
                                                            </select>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group year_of_study required">
                                                            <label class="control-label"
                                                                for="year_of_study">Grade/Class/Year
                                                                of
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group instititution_telephone_number required">
                                                            <label class="control-label"
                                                                for="instititution_telephone_number">Institution's
                                                                Telephone
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group total_fees_payable required">
                                                            <label class="control-label" for="total_fees_payable">Total
                                                                Fees
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group bank_name required">
                                                            <label class="control-label" for="bank_name">Name of
                                                            ...
                                                            <select id="bank_name" name="bank_name"
                                                                ...
                                                                <option value="Cooperative Bank of Kenya">Cooperative Bank
                                                                    of
                                                                    Kenya</option>
                                                                <option
                                                                    value="Barclays Bank of Kenya (Absa Bank Kenya PLC)">
                                                                ...
                                                                <option value="Diamond Trust Bank Kenya">Diamond Trust Bank
                                                                    Kenya</option>
                                                                <option value="National Bank of Kenya">National Bank of
                                                                    Kenya
                                                                </option>
                                                                <option value="NIC Bank (Now part of NCBA Bank)">NIC Bank
                                                                    (Now
                                                                    part of NCBA Bank)</option>
                                                                <option
                                                                    value="Commercial Bank of Africa (CBA) - Merged with NIC Bank to form NCBA Bank">
                                                                    Commercial Bank of Africa (CBA) - Merged with NIC Bank
                                                                    to
                                                                ...
                                                                <option value="Family Bank Kenya">Family Bank Kenya
                                                                </option>
                                                                <option value="Gulf African Bank">Gulf African Bank
                                                                </option>
                                                                <option value="Credit Bank Kenya">Credit Bank Kenya
                                                                </option>
                                                                <option value="Prime Bank Kenya">Prime Bank Kenya</option>
                                                                <option value="Sidian Bank (formerly K-Rep Bank)">Sidian
                                                                    Bank
                                                                    (formerly K-Rep Bank)</option>
                                                                <option value="Victoria Commercial Bank">Victoria
                                                                    Commercial
                                                                    Bank</option>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group birth_certificate required">
                                                            <label class="control-label" for="birth_certificate">Birth
                                                                Certificate
                                                                Photocopy: <span class="text-danger">*</span></label>
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group current_fee_structure required">
                                                            <label class="control-label"
                                                                for="current_fee_structure">Current
                                                                Fee
                                                            ...
                                                            <input type="file" id="current_fee_structure"
                                                                ...
                                                                name="current_fee_structure" aria-required="true"
                                                                required>
                                            ...
                                            <div class="form-navigation">
                                                <button type="button"
                                                    class="btn-sm previous btn btn-info float-left"><span
                                                        aria-hidden="true">&laquo;</span> Previous</button>
                                                <button type="button" class="btn-sm next btn btn-info float-right">Next
                                                    <span aria-hidden="true">&raquo;</span></button>
                                                <button type="submit" id="submitButton"
                                                    class="btn-sm btn btn-success float-right"><i class="fas fa-save"></i>
                                                    Submit</button>
                                            </div>
                                ...
                                @endif
                            @else
                                <h4 class="text-center text-danger fas fa-folder-open p-4"> No active application</h4>
                            @endif
