                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-info">
                            ...
                            <!-- form start -->
                            <div class="card-body">
                                <form id="application_form" action="{{route('user.bursary.store')}}" class="bursary-form" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="form-section">
                                        <div class="row">
                                            <div class="col-md-12 m-1">
                                                <h5 class="text-center text-bold">Key Attachments</h5>
                                            </div>
                                            <div class="col-md-4">
                                    ...
                                    {{-- previous, next and submit buttons --}}
                                        ...
                                        <div class="form-navigation">
                                            <button type="button" class="btn-sm previous btn btn-info float-left">Previous</button>
                                            <button type="button" class="btn-sm next btn btn-info float-right">next</button>
                                            <button type="submit" class="btn-sm btn btn-success float-right">Submit</button>
                                        </div>
