                                    ...
                                    <div class="card-body pt-0">
                                        <form id="application_form" action="{{ route('user.bursary.store') }}"
                                                    ...
                                                    $('#ward').change(function() {
                                                        ...
                                                        $.get('/user-bursary/fetch-locations/' + wardName, function(data) {
                                                            if (data.length > 0) {
                                                                ...
                                                                // Populate location select with fetched data
                                                                $.each(data, function(index, location) {
                                                                    $('#location').append('<option value="' + location.name + '">' +
                                                    ...
                                                    $('#location').change(function() {
                                                        ...
                                                        $.get('/user-bursary/fetch-sub-locations/' + locationName, function(data) {
                                                            if (data.length > 0) {
                                                                ...
                                                                // Populate sub-location select with fetched data
                                                                $.each(data, function(index, subLocation) {
                                                                    $('#sub_location').append('<option value="' + subLocation.name +
                                                    ...
                                                    $('#sub_location').change(function() {
                                                        ...
                                                        $.get('/user-bursary/fetch-polling-stations/' + subLocationName, function(data) {
                                                            if (data.length > 0) {
                                                                ...
                                                                // Populate polling station select with fetched data
                                                                $.each(data, function(index, pollingStation) {
                                                                    $('#polling_station').append('<option value="' + pollingStation
                                                                        .name + '">' + pollingStation.name + '</option>');
                                                                });
                                                            }
                                                        });
                                                    });
                                            ...
                                            <div class="form-navigation">
                                                ...
                                                <button type="button"
                                                    class="btn-sm next btn btn-info float-right">Next <span aria-hidden="true">&raquo;</span></button>
                                                <button type="submit" id="submitButton"
                                                    class="btn-sm btn btn-success float-right"><i class="fas fa-save"></i> Submit</button>
                                            </div>
