                                                            ...
                                                            <ul class="nav nav-tabs">
                                                                <li class="nav-item p-0">
                                                                    <a class="nav-link active"
                                                                        href="#step-1-{{ $bursary->id }}"
                                                                        data-toggle="tab">Personal Details</a>
                                                                </li>
                                                                <li class="nav-item">
                                                                    <a class="nav-link" href="#step-2-{{ $bursary->id }}"
                                                                        data-toggle="tab">Family Information</a>
                                                                </li>
                                                                <li class="nav-item">
                                                                    <a class="nav-link" href="#step-3-{{ $bursary->id }}"
                                                                        data-toggle="tab">Address Information</a>
                                                                </li>
                                                                <li class="nav-item">
                                                                    <a class="nav-link" href="#step-4-{{ $bursary->id }}"
                                                                        data-toggle="tab">School Details</a>
                                                                </li>
                                                                
                                                                <li class="nav-item">
                                                                    <a class="nav-link" href="#step-5-{{ $bursary->id }}"
                                                                        data-toggle="tab">Key Attachments</a>
                                                                </li>
                                                            </ul>
                                                            <div class="tab-content">
                                                                {{-- personal details --}}
                                                                <div class="tab-pane active" id="step-1-{{ $bursary->id }}">
                                                                ...
                                                                <div class="tab-pane" id="step-2-{{ $bursary->id }}">
                                                                ...
                                                                {{-- address information --}}
                                                                <div class="tab-pane active" id="step-3-{{ $bursary->id }}">
                                                                ...
                                                                {{-- school details --}}
                                                                <div class="tab-pane" id="step-4-{{ $bursary->id }}">
                                                                ...
                                                                {{-- key attachments --}}
                                                                <div class="tab-pane" id="step-5-{{ $bursary->id }}">
